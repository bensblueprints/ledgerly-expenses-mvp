...
import { LayoutDashboard, Receipt, BarChart3, Wallet, Settings as SettingsIcon, LogOut, Lock, BookOpen } from 'lucide-react';
import { api } from './api';
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="font-bold text-lg leading-tight">Ledgerly</h1>
    ...
    <div className="min-h-screen max-w-6xl mx-auto px-4 py-6">
      <header className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-lg">Ledgerly</h1>
        </div>
        <button
      ...
      <nav className="flex gap-1 mb-6 bg-zinc-900/70 border border-zinc-800 rounded-xl p-1 overflow-x-auto">
        {TABS.map((t) => (
          ...
          >
            {tab === t.id && (
              <motion.span layoutId="tab-bg" className="absolute inset-0 bg-emerald-600/90 rounded-lg" transition={{ type: 'spring', duration: 0.4 }} />
            )}
